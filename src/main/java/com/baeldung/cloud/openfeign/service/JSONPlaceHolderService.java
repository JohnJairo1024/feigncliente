...
public class JSONPlaceHolderService {
    ...
    public ConsultaMatriculaResponse getMatriculaResponses(String usuario, String codCam, String mat) {
        return jsonPlaceHolderClient.getMatriculaResponses(usuario, codCam, mat);
    }
}
